"""
Django settings for drf_git project.
...
SECRET_KEY = 'django-insecure-zrery(zcpr!)y8g1x_q&3_)h=jnv0j8_d(z0o&sdgh!7*=dguw'
...
WSGI_APPLICATION = 'drf_git.wsgi.application'
